...
--
-- Table structure for table `users_blogs_views`
--

DROP TABLE IF EXISTS `users_blogs_views`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `users_blogs_views` (
  ...
  `view_length` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `users_blogs_views`
--

LOCK TABLES `users_blogs_views` WRITE;
/*!40000 ALTER TABLE `users_blogs_views` DISABLE KEYS */;
/*!40000 ALTER TABLE `users_blogs_views` ENABLE KEYS */;
UNLOCK TABLES;
